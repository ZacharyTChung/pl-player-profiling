...
than method: at seven seconds a report a full season is a few hours. Extending to other leagues would test whether the two-cluster result is a
property of the reduced feature set or of the Premier League specifically, and we expect the
former. Symmetric adjustment of the attacking statistics was tested and deliberately not adopted,
