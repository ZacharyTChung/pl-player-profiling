...
such as shot accuracy, are left alone rather than being divided a second time. Minutes
...
low quality shots from one who takes two good ones, and no statistic here is adjusted for
the share of possession a player's team enjoys, which systematically inflates the
defensive counts of players in teams that spend more time without the ball. Per-90 rates
